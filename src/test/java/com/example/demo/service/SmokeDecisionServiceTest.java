...
public class SmokeDecisionServiceTest {
    ...
    void testContinuousSmokeRise() {
        ...
        service.analyze(101L,20);
        service.analyze(101L,25);
        service.analyze(101L,35);
        service.analyze(101L,50);

        SmokeDecision result =
                service.analyze(101L,65);
    ...
    void testRisingTrend() {
        ...
        service.analyze(101L,20);
        service.analyze(101L,22);
        service.analyze(101L,25);
        service.analyze(101L,29);

        SmokeDecision result =
                service.analyze(101L,34);
